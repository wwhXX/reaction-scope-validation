...
# ==================== 全局配置 ====================
SUBSTRATE_FILE = 'zrz_select.csv'
SUBSTRATE_FP_FILE = 'fp_spoc_morgan41024_Maccs_zrz_select_alcohol.csv'
EXPERIMENTAL_FILE = 'zrz_ol.csv'
EXPERIMENTAL_FP_FILE = 'fp_spoc_morgan41024_Maccs_zrz_ol_alcohol.csv'
