...
# ==================== 全局配置 ====================
SUBSTRATE_FILE = '底物醇去重.csv'
SUBSTRATE_FP_FILE = 'fp_spoc_morgan41024_Maccs_底物醇去重_alcohol.csv'
EXPERIMENTAL_FILE = 'experimental_data_results_of_alcohol_ol.csv'
EXPERIMENTAL_FP_FILE = 'fp_spoc_morgan41024_Maccs_experimental_data_results_of_alcohol_ol_alcohol.csv'
