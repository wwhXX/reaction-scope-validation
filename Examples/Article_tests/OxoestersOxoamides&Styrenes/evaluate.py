...
# ==================== 全局配置 ====================
SUBSTRATE_FILE = 'dyd_phenylethylene_select.csv'
SUBSTRATE_FP_FILE = 'fp_spoc_morgan41024_Maccs_dyd_phenylethylene_select_alcohol.csv'
EXPERIMENTAL_FILE = 'dyd_phenylethylene_ol.csv'
EXPERIMENTAL_FP_FILE = 'fp_spoc_morgan41024_Maccs_dyd_phenylethylene_ol_alcohol.csv'
